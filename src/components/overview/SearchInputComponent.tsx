/**
 * @fileoverview SearchInputComponent for filtering decisions in Overview page
 * 
 * A standalone search input component that maintains its own state
 * to avoid re-rendering and focus issues. Handles input value changes
...
/**
 * Props for the SearchInputComponent
 * 
 * @interface SearchInputComponentProps
 * @property {function} onSearchChange - Callback function that receives the search term when it changes
 */
interface SearchInputComponentProps {
 ...
 * 
 * @component
 * @param {SearchInputComponentProps} props - Component props
